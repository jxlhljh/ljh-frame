...
Ext.ux.form.DateTime = Ext.extend(Ext.form.Field, { 
    ...
    /** 
     * @cfg {String} dtSeparator Date - Time separator. Used to split date and time (defaults to ' ' (s
pace)) 
     */ 
    ,dtSeparator:' ' 
    /** 
     ...
     */ 
    /** 
     * @cfg {String} timePosition Where the time field should be rendered. 'right' is suitable for for
ms 
    ...
    /** 
     * @private 
     * Renders underlying DateField and TimeField and provides a workaround for side error icon b
ug 
     */ 
